<%@ Page Title="" Language="C#" MasterPageFile="~/sideEmpleado.Master" AutoEventWireup="true" CodeBehind="homeEmpleado.aspx.cs" Inherits="gestor_tiendas_pw.homeEmpleado" %>
    ...
    <div class="container">
        ...
        <div class="row px-5">
            <div class="col-6">
                ...
                <div class="row pt-3">
                    <div class="form">
                        <span class="form_des">Tienda:</span>
                        <asp:Label ID="lbl_tienda" class="lbl_dat" runat="server"></asp:Label>
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="row pt-5">
                    ...
                    <div class="col-6">
                         <asp:Button ID="btn_update" class="btn btn-primary disN" runat="server" Text="ACTUALIZAR" OnClick="btn_update_Click"/>
                    </div>
                </div>
